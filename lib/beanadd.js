...
module.exports = class BeanAdd {
	constructor(onSubmit, onCancel) {
		...
		this.payeeInput = this.createInput('Payee', '', 'text', [], 'payee-list');
		...
		this.accountList = document.createElement('datalist');
		this.accountList.id = 'account-list';

		this.payeeList = document.createElement('datalist');
		this.payeeList.id = 'payee-list';
		...
		form.appendChild(this.accountList);
		form.appendChild(this.payeeList);
	...
	createInput(placeholder='', value='', type='text', classes=[], list='') {
	...
	reset(accounts, payees) {
		...
		this.updateList(this.accountList, accounts);
		this.updateList(this.payeeList, payees);
	}
	...
	createPosting(del=false) {
		...
		const postingAccount = this.createInput('Account', '', 'text', ['post', 'post-account'], 'account-list');
